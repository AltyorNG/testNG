...
<Library LVVersion="20008000">
	...
	<Item Name="Virtual Don&apos;t Use" Type="Folder">
		<Item Name="Class File (Default).lvclass" Type="LVClass" URL="../Class File (Default)/Class File (Default).lvclass"/>
	</Item>
	<Item Name="Class CSV_File.lvclass" Type="LVClass" URL="../CSV_File (Default)/Class CSV_File.lvclass"/>
</Library>

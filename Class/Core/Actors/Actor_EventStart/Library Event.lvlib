...
<Library LVVersion="20008000">
	...
	<Item Name="Parent" Type="Folder">
		<Item Name="Children" Type="Folder">
			<Item Name="Class Event Balance.lvclass" Type="LVClass" URL="../Class Event Balance/Class Event Balance.lvclass"/>
			<Item Name="Class Event DIO.lvclass" Type="LVClass" URL="../Class Event DIO/Class Event DIO.lvclass"/>
			<Item Name="Class Event Shielding Box.lvclass" Type="LVClass" URL="../Class Event Shielding Box/Class Event Shielding Box.lvclass"/>
		</Item>
		<Item Name="Class Event (Default).lvclass" Type="LVClass" URL="../Classe Event (Default)/Class Event (Default).lvclass"/>
	</Item>
</Library>

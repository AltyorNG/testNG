...
echo %5 flash --device=EFR32MG21A010F1024IM32 %1
...
REM enable Secure debug functionnality
%5 security lockconfig --secure-debug-unlock enable --device=EFR32MG21A010F1024IM32